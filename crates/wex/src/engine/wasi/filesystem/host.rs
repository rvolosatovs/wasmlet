...
use crate::engine::bindings::wasi::filesystem::{preopens, types};
use crate::engine::wasi;
use crate::engine::wasi::filesystem::{
    Descriptor, DirPerms, DirectoryEntryStream, FilePerms, WasiFilesystemImpl, WasiFilesystemView,
};
...
impl<T> types::Host for WasiFilesystemImpl<T>
where
...
impl<T> types::HostDirectoryEntryStream for WasiFilesystemImpl<T>
where
    T: WasiFilesystemView,
{
