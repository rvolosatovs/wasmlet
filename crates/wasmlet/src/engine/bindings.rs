    ...
    wasmtime::component::bindgen!({
        async: {
            only_imports: [
                ...
                "wasi:io/streams@0.2.5#[method]input-stream.blocking-skip",
                "wasi:io/streams@0.2.5#[method]output-stream.blocking-flush",
                "wasi:io/streams@0.2.5#[method]output-stream.blocking-splice",
                "wasi:io/streams@0.2.5#[method]output-stream.blocking-write-and-flush",
                "wasi:io/streams@0.2.5#[method]output-stream.blocking-write-zeroes-and-flush",
            ],
        },
        tracing: true,
