    ...
    with nixify.lib;
      rust.mkFlake {
        ...
        withPackages = {
          ...
          wex-aarch64-unknown-linux-gnu-fhs = mkFHS {
            name = "wex-aarch64-unknown-linux-gnu-fhs";
            src = packages.wex-aarch64-unknown-linux-gnu;
            interpreter = interpreters.aarch64-unknown-linux-gnu;
          };

          wex-riscv64gc-unknown-linux-gnu-fhs = mkFHS {
            name = "wex-riscv64gc-unknown-linux-gnu-fhs";
            src = packages.wex-riscv64gc-unknown-linux-gnu;
            interpreter = interpreters.riscv64gc-unknown-linux-gnu;
          };

          wex-x86_64-unknown-linux-gnu-fhs = mkFHS {
            name = "wex-x86_64-unknown-linux-gnu-fhs";
            src = packages.wex-x86_64-unknown-linux-gnu;
        ...
        in
          ...
          // {
            inherit
              wex-aarch64-unknown-linux-gnu-fhs
              wex-riscv64gc-unknown-linux-gnu-fhs
              wex-x86_64-unknown-linux-gnu-fhs
              ;
