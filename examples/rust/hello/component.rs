    ...
    pub mod test {
      ...
      pub fn stringin(p: &str,) -> (){
        unsafe {
          ...
          #[link(wasm_import_module = "wex-examples:rust-hello/test")]
          unsafe extern "C" {
            #[link_name = "stringin"]
      ...
      pub fn numbers(p: u64,) -> u32{
        unsafe {
          ...
          let ret = unsafe { wit_import0(_rt::as_i64(&p)) };
          ret as u32
        }
      }
      #[allow(unused_unsafe, clippy::all)]
      pub fn lists(p: &[u32],) -> _rt::Vec::<u32>{
        unsafe {
      ...
      #[allow(unused_unsafe, clippy::all)]
      pub fn small(a: u8,b: u16,c: u32,aa: i8,bb: i16,) -> (u8,u16,u32,){
        unsafe {
          ...
          unsafe extern "C" {
            #[link_name = "small"]
            fn wit_import1(_: i32, _: i32, _: i32, _: i32, _: i32, _: *mut u8, );
          }

          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1(_rt::as_i32(&a), _rt::as_i32(&b), _rt::as_i32(&c), _rt::as_i32(&aa), _rt::as_i32(&bb), ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let l3 = i32::from(*ptr0.add(2).cast::<u16>());
          let l4 = *ptr0.add(4).cast::<i32>();
          let result5 = (l2 as u8, l3 as u16, l4 as u32);
          result5
        }
      }
      #[allow(unused_unsafe, clippy::all)]
      pub fn floats(a: f32,b: f64,) -> (f32,f64,){
        unsafe {
          ...
          unsafe extern "C" {
            #[link_name = "floats"]
            fn wit_import1(_: f32, _: f64, _: *mut u8, );
          }

          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: f32, _: f64, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1(_rt::as_f32(&a), _rt::as_f64(&b), ptr0) };
...
pub mod exports {
  pub mod wex_examples {
    pub mod hello {
      ...
      pub mod handler {
        ...
        pub unsafe fn _export_hello_cabi<T: Guest>() -> *mut u8 {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result0 = T::hello();
  ...
  pub mod rust_hello {
    ...
    pub mod test {
      ...
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn _export_stringin_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) {#[cfg(target_arch="wasm32")]
    ...
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub unsafe fn _export_numbers_cabi<T: Guest>(arg0: i64,) -> i32 {#[cfg(target_arch="wasm32")]
    _rt::run_ctors_once();let result0 = T::numbers(arg0 as u64);
    _rt::as_i32(result0)
  }
  #[doc(hidden)]
  #[allow(non_snake_case)]
  pub unsafe fn _export_lists_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 {#[cfg(target_arch="wasm32")]
  _rt::run_ctors_once();let len0 = arg1;
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_small_cabi<T: Guest>(arg0: i32,arg1: i32,arg2: i32,arg3: i32,arg4: i32,) -> *mut u8 {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result0 = T::small(arg0 as u8, arg1 as u16, arg2 as u32, arg3 as i8, arg4 as i16);
let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_floats_cabi<T: Guest>(arg0: f32,arg1: f64,) -> *mut u8 {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result0 = T::floats(arg0, arg1);
let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
...
A\x06\x01B\x0d\x01@\x01\x01ps\x01\0\x04\0\x08stringin\x01\0\x01@\x01\x01pw\0y\x04\
...
vu\x01@\x02\x01av\x01bu\0\x06\x04\0\x06floats\x01\x07\x03\0\x1cwex-examples:rust\
-hello/test\x05\0\x01B\x0d\x01@\x01\x01ps\x01\0\x04\0\x08stringin\x01\0\x01@\x01\
\x01pw\0y\x04\0\x07numbers\x01\x01\x01py\x01@\x01\x01p\x02\0\x02\x04\0\x05lists\x01\
\x03\x01o\x03}{y\x01@\x05\x01a}\x01b{\x01cy\x02aa~\x02bb|\0\x04\x04\0\x05small\x01\
\x05\x01o\x02vu\x01@\x02\x01av\x01bu\0\x06\x04\0\x06floats\x01\x07\x04\0\x1cwex-\
examples:rust-hello/test\x05\x01\x01B\x02\x01@\0\0s\x04\0\x05hello\x01\0\x04\0\x1a\
wex-examples:hello/handler\x05\x02\x04\0!wex-examples:rust-hello/component\x04\0\
