...
use bindings::wex_examples::redis::commands::{Command, Get, Hello, Ping};
use bindings::wex_examples::redis::database::PendingConnection;
use bindings::wex_examples::redis::pool;
use bindings::wex_examples::redis::pool::Connection;
use bindings::wex_examples::redis::resp3::{self, FrameValue, IndirectValue, Value};

struct Handler;

impl bindings::exports::wex_examples::hello::handler::Guest for Handler {
    fn hello() -> String {
